  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        <Link href="/payments" className="inline-flex items-center text-green-500 hover:underline mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-gray-900 border border-gray-800">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Share this link with your customer</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <label className="text-sm font-medium text-gray-300">Payment Link</label>
                <div className="flex items-center mt-1 space-x-2">
                  <input
                    type="text"
                    value={`${window.location.origin}/pay/${payment.id}`}
                    readOnly
                    className="flex-1 px-3 py-2 border border-gray-700 rounded-md text-sm bg-gray-800 text-white"
                  />
                  <Button
                    variant="outline"
                    size="icon"
              ...
              <div>
                ...
                <p className="text-2xl font-bold mt-1 text-white">{payment.amount} USDT</p>
              </div>
          ...
          <Card className="bg-gray-900 border border-gray-800">
            <CardHeader>
              <CardTitle className="text-white">Pay with USDT</CardTitle>
              <CardDescription className="text-gray-400">Send USDT to this address</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-300">Tron Address</label>
                <div className="flex items-center mt-1 space-x-2">
                  <input
                    type="text"
                    value={payment.tronAddress}
                    readOnly
                    className="flex-1 px-3 py-2 border border-gray-700 rounded-md text-sm bg-gray-800 text-white font-mono"
                  />
                  <Button
                    variant="outline"
                    size="icon"
